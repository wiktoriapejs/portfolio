...
const Contact = () => {
  return (
    <div  className='bg-gradient-to-b from-white to-gray-300 w-full text-black pb-20 pt-[50rem] sm:pt-[48rem] md:pt-[30rem] lg:pt-[5rem] '>
      
        <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full lg:pt-[0rem]  md:pt-[30rem]  pt-[25rem]">
            <div className="pb-8">
                <p name="contact" className="text-4xl font-bold border-b-4 border-gray-500">Contact</p>
